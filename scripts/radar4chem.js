function transforming(input) {
  ...
  if(input["oai_dc:dc"]["dc:description"]){
    if (typeof input["oai_dc:dc"]["dc:description"] === "object"){
    output.description = [
      {
        "@value": input["oai_dc:dc"]["dc:description"][0],
        "@language": params.defaultLanguage,
      },
    ];
  }else{
  ...
  output.distribution = [
    {
      ...
      accessURL: {
        "@id": encodeURI(decodeURI(input["oai_dc:dc"]["dc:identifier"])),
      },
      title:[
        {
          "@value": input["oai_dc:dc"]["dc:title"],
