function transforming(input) {
  ...
  // console.log(JSON.stringify(input["oai_dc:dc"]));
  var output = {
    "@context": {
  ...
  if (input["oai_dc:dc"]["id"]){
      output.identifier = [
      {
        "@value": input["oai_dc:dc"]["id"].replace("doi:","https://doi.org/"),
        "@language": params.defaultLanguage,
      },];
    }
  if (input["oai_dc:dc"]["dc:date"]){
      output.issued = input["oai_dc:dc"]["dc:date"][0]
    }
  ...
  if (input["oai_dc:dc"]["dc:creator"]) {
      creators = "";
        ...
        if (typeof input["oai_dc:dc"]["dc:creator"] === "object") {

          for (const creator of input["oai_dc:dc"]["dc:creator"]) {
  ...
  if (input["oai_dc:dc"]["dc:rights"]) {
    ...
    if (typeof input["oai_dc:dc"]["dc:rights"] === "object") {
        for (const subject of input["oai_dc:dc"]["dc:rights"]) {
          rights.push({
            "@value": subject,
            "@language": params.defaultLanguage,
          });
      ...
      rights = [
        {
          "@value": input["oai_dc:dc"]["dc:rights"],
          "@language": params.defaultLanguage,
        },
      ];
    }
